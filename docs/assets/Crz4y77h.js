import{_ as A}from"./CtMkW8tX.js";import{_ as M}from"./Bpml4Klo.js";import{u as $}from"./RzecsJre.js";import{m as d,h as g,c as v,o as i,a as u,b as _,w as f,d as h,n as k,q as r,s as j,u as N,v as V,F as B}from"#entry";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const O=({name:e,iconNode:t,absoluteStrokeWidth:o,"absolute-stroke-width":s,strokeWidth:n,"stroke-width":l,size:a=c.width,color:C=c.stroke,...m},{slots:p})=>d("svg",{...c,...m,width:a,height:a,stroke:C,"stroke-width":x(o)||x(s)||o===!0||s===!0?Number(n||l||c["stroke-width"])*24/Number(a):n||l||c["stroke-width"],class:H("lucide",m.class,...e?[`lucide-${w(q(e))}-icon`,`lucide-${w(e)}`]:["lucide-icon"])},[...t.map(b=>d(...b)),...p.default?[p.default()]:[]]);/**
 * @license lucide-vue-next v0.545.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const E=y("volume-off",[["path",{d:"M16 9a5 5 0 0 1 .95 2.293",key:"1fgyg8"}],["path",{d:"M19.364 5.636a9 9 0 0 1 1.889 9.96",key:"l3zxae"}],["path",{d:"m2 2 20 20",key:"1ooewy"}],["path",{d:"m7 7-.587.587A1.4 1.4 0 0 1 5.416 8H3a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h2.416a1.4 1.4 0 0 1 .997.413l3.383 3.384A.705.705 0 0 0 11 19.298V11",key:"1gbwow"}],["path",{d:"M9.828 4.172A.686.686 0 0 1 11 4.657v.686",key:"s2je0y"}]]),F={class:"sticky z-40 top-0 bg-white/10 backdrop-blur-sm w-full flex justify-center"},I={class:"container flex h-14 max-w-screen-2xl items-center px-4"},K={class:"md:mr-1 md:flex"},U={class:"flex flex-1 items-center justify-end space-x-2"},Z=g({__name:"Navbar",setup(e){const{isMuted:t,toggleMute:o}=$();return(s,n)=>{const l=A,a=M;return i(),v("header",F,[u("div",I,[_(a,{to:"/"},{default:f(()=>[u("div",K,[_(l,null,{default:f(()=>[...n[0]||(n[0]=[h("キ",-1)])]),_:1}),n[1]||(n[1]=h("ミノコエ",-1))])]),_:1}),u("div",U,[r(t)?(i(),k(r(z),{key:0,onClick:r(o)},null,8,["onClick"])):(i(),k(r(E),{key:1,onClick:r(o)},null,8,["onClick"]))])])])}}}),P=Object.assign(Z,{__name:"KiNavbar"}),S={class:"main"},Q=g({__name:"default",setup(e){return j({robots:()=>({noindex:!0})}),N({title:"キミノコエ"}),(t,o)=>{const s=P;return i(),v(B,null,[_(s),u("div",S,[V(t.$slots,"default")])],64)}}});export{Q as default};
